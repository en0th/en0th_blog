...
![image.png](../../images/posts/f152020e3e8a2e4ab430e9a41a1042a4.png)
此时我们将文件写入进去了，但文件内容为空。
![image.png](../../images/posts/3a624561c468fd246e66bb94586fcfbb.png)
下一步，我们将文件名修改成`picture.png<<<`，再把文件内容修改成`<?= phpinfo();`![image.png](../../images/posts/1add8e35f6276c42e2aa3e46bf861c5e.png)
上传成功后，我们访问路径`uploads/picture.png.php`发现已经代码已经执行，说明通过这样的方式可以写入内容。
![image.png](../../images/posts/fd11a17d1d603a3af16bc84415ea60f4.png)
![image.png](../../images/posts/3d8085aa4186d20a5b0162ecc47a420e.png)
## 2）为什么会有这样的效果？
我们在很早以前就已经知道Windows下文件命名是有规则的。
![image.png](../../images/posts/8bb00a7514db23cf6c242628c26fbbd1.png)
...
![image.png](../../images/posts/f88dac59e7e465b5912b8efa48e0614b.png)
使用`test.jpg<<<`进行匹配，果然先匹配到了`test.jpg`和`test.jpg.jpg`，从而导致给php文件写入失败。
`<<`效果测试：
需要注意单个`<`无法正常匹配到结果，只有连着使用两个或两个以上`<`才有通配符`*`的效果。
![image.png](../../images/posts/923dda66a1cac944c9f762bafdaa8a39.png)
删除`test.jpg`再次使用相同的参数请求，匹配到`test.jpg.aaa`
![image.png](../../images/posts/27f3f0c4320d6c36068b124f67a413d0.png)
删除`test.jpg.aaa`再次使用相同的参数请求，匹配到`test.jpg.jpg`
![image.png](../../images/posts/778d5def574b41f7195e965c86be55a7.png)
删除`test.jpg.jpg`文件后再次使用`test.jpg<<<`进行匹配，成功获得`.php`文件
![image.png](../../images/posts/8645c4d88d7a836c64527ce8afa4124f.png)
**对其他符号同样进行测试**
`>`效果测试：
单独`>`可以匹配零个或一个字符，效果类似于通配符`?`，缺失多少拼接多少`>`就可以匹配到对应的文件。
![image.png](../../images/posts/821d76894d7190b9d18228dc12de3a4f.png)
但经过测试无法代替文件名中的字符`.`使用
![image.png](../../images/posts/7a60e142986e7006c6e61b7765dd0e06.png)
`"`效果测试：
符号`"`可以匹配到字符`.`。
![image.png](../../images/posts/ca7fafa67265d17a75ff8e8af86d2a67.png)
## 4）如何自行验证？
