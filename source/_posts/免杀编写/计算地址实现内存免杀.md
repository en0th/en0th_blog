...
效果：
![企业微信截图_16976957489579.png](../../images/posts/cddcd1b548d2d4d6e473007086031e55.png)![企业微信截图_1697695803882.png](../../images/posts/f76a28dbe78ae1ee5ec0d1fe08b0294f.png)
# 0x03 免杀制作思路
## 1、静态免杀
...
![image.png](../../images/posts/8be04b429ad66e60ba6f648a78fe8e49.png)
`e8 call`的格式是`CALL Jz`，那么这里的`f64`和`Jz`是什么意思呢，继续翻官方文档：
![image.png](../../images/posts/9d054d0cb522eefdd6e8e87b2202cd72.png)
![image.png](../../images/posts/81f58b2172f6570016f296324b9583a0.png)
![image.png](../../images/posts/270a244e5a83babefb32fbc3b2d06081.png)
...
![image.png](../../images/posts/0270fbda3e3940b9a15f59490e1fc107.png)
![image.png](../../images/posts/162262b93e3278ce119f3bed65368c21.png)
![image.png](../../images/posts/178c816e2290ec3dd91c2b763e3e4a4e.png)
最后将算出的四字节偏移填充到`e8`后面就好了，比如我这里按照Windows的小端存储方式，最后的结果就应该是`e8 2b 10 06 00`：
![image.png](../../images/posts/8ffb8bf66c7bfb6a9800683a8bedc7c9.png)
...
![image.png](../../images/posts/4cc8c1b08c69c8a456e733f0dc1ee17f.png)
### CPU 内核数量检测
