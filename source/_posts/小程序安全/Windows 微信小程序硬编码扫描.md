...
![](../../images/posts/e0c8d0b75fb4ea3bcb8b1b9b361301cc.png)

进入到其中一个可以看到`__APP__.wxapkg`这个就是主包，

如果出现除这个之外的多个的`.wxapkg`文件那么就是主包+分包的形式。

![](../../images/posts/bcaba75628389ddb4cf0b3e93ff05930.png)
...
![](../../images/posts/5c26dcb170f1c4b93b52866cabeef4e8.png)
...
![](../../images/posts/c8b391228f1b41b7eca87308f4fa8154.png)
...
`gitleaks detect -s <source_path> <font style="color:rgb(36, 41, 47);">--no-git -r <outfile_path></font>`

<font style="color:rgb(36, 41, 47);">例如：</font>

`.\gitleaks.exe detect -s C:\Users\abc\Downloads\wxpack --no-git -r 1.json`

![](../../images/posts/1014d599ee65675d660b5bcd1a9850e9.png)
