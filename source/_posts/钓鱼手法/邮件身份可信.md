...
![image.png](../../images/posts/6ad304e1d4862b5baefdb87102ed29ed.png)
# 设置身份验证
通过身份验证的邮件：
...
![image.png](../../images/posts/855d255f766e7ef1d5fb13c28ece48da.png)
## 邮件可信度测试地址
...
![image.png](../../images/posts/bb0d503355abe74c7f53b9b77cffdebb.png)
还有一种被动检查方式
[https://en.internet.nl/test-mail/](https://en.internet.nl/test-mail/)
![image.png](../../images/posts/8c4f67d6c6942aadfecefd130292d2ea.png)
...
![image.png](../../images/posts/22fc30532a98dad8e273e24965936a76.png)
...
![image.png](../../images/posts/5add2ea8c002edb8925536dbaf39ef1c.png)
## 设置 AAAA 记录
将 `mail.mydomain.com` 的 AAAA 记录指向你的 VPS 服务器（邮件服务器）IPv6地址
检测方式：`nslookup mail.mydomain.com`
![image.png](../../images/posts/89edfc811a6726095dbfd19f0d588151.png)
## 设置 MX 记录
MX 记录就是邮件的解析记录，非常重要的一条记录，配置根域名的 MX 记录为自己的邮件域名地址，优先级为 10
检测方式：`nslookup -type=mx mydomain.com`
![image.png](../../images/posts/f758c9215ba7d8f5b779452e688ccfe3.png)
## 设置 DMARC 记录
...
![image.png](../../images/posts/9a29b70d09528a07637ab7cc8c73d74a.png)
...
![image.png](../../images/posts/603bb763a11ae3982e1be0645b9b41e1.png)
开启后会给出几个值。
![image.png](../../images/posts/dcc6e83f38ed6309ade2c0619e9f2558.png)
...
![image.png](../../images/posts/9ccaa936fde9e7d64f3d6060824edc0f.png)
其中的 Key tag、Algorithm、Digest Type、Digest按照提供的数据填写后点击 Update 即可。
![image.png](../../images/posts/5f121a7e01eaf6c565654e000fef0c7a.png)
## 设置 DKIM 记录 【重点】
...
![image.png](../../images/posts/06537207a8ac85454c030ebda9b75b61.png)
#### 2、安装服务
...
![image.png](../../images/posts/9d41451a3b05ce29a56c3bd8c01f1b72.png)
...
![image.png](../../images/posts/d14137dd53ae7d98680674e3f067a66d.png)
## 申请并设置 TLS/SSL 证书 
...
![image.png](../../images/posts/e4f648fc69808899f5c727244386fe36.png)
填入你的域名然后点击添加。
![image.png](../../images/posts/e325bafed70f9dfde87c2b2b87e67a3a.png)
然后到你的域名商控制台，将域名服务器更换成 cloudflare 提供的域名服务器。
![image.png](../../images/posts/eed0ff15e1cec566f135429ea9eda1ec.png)
...
![image.png](../../images/posts/225c503fe160375e319495a817cd06d6.png)
```
...
![image.png](../../images/posts/9a962e923f427acc7198b71de0c5bd58.png)
...
![image.png](../../images/posts/b4029108b772d0b41ea190df66044bbf.png)
...
![image.png](../../images/posts/65d7855c2b51bc91f80c040bb5af6ecc.png)
...
.
```
![image.png](../../images/posts/fc3f405d621dc81c1917388268543886.png)
注意最后的 `.` 
```
tail -20 /var/log/maillog
```
看到接收方邮件服务器验证 `verify=OK` 即可。
![image.png](../../images/posts/5e5bec4bb95fa3e74cbba1a4d518b94d.png)
如果是 `verify=FAIL`可以根据 `verifymsg`来判断问题。
![image.png](../../images/posts/6f707948964319a9fa1489a6366e577e.png)
### FreeSSL 申请证书
...
![image.png](../../images/posts/d5b3b7a34adb2ea5239ce988ddb86e97.png)
...
![image.png](../../images/posts/ea88f183a9030df40f637a946092a2b0.png)
...
![image.png](../../images/posts/dbe35d2409edbc633c988a8316227d76.png)
